...
const AdminNav: React.FC<AdminNavType> = ({
  ...
  return (
    <div className="flex relative items-center justify-between w-full max-sm:border-none border-b custom-height max-sm:py-2 my-2 md:my-3 py-4">
      ...
      {/* <div className='w-full absolute h-[1px] bottom-0 mt-5 bg-gray-500'></div> */}
    </div>
  );
};
