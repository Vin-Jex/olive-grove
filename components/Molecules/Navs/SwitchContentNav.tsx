        ...
        {navLink?.map((item: string) => {
          return (
            <li
              ...
              className={`flex items-center justify-center relative font-roboto text-sm text-subtext/40 py-2.5 px-3 capitalize cursor-pointer transition ease-in duration-100 border-subtext/20 border-y-[1.7px] first:border-l-[1.7px] last:border-r-[1.7px] first:rounded-tl-xl first:rounded-bl-xl last:rounded-tr-xl last:rounded-br-xl min-w-[120px] ${
                activeItem === item &&
