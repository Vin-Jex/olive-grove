...
const SearchLayout: FC<{
  ...
  return (
    <div className='relative'>
      <span className='absolute grid place-items-center z-10 h-full -top-[2px] left-2'>
        <SearchIcon />
      </span>
      <Input
        value={value} 
        ...
        placeholder='Search'
        className='!w-[20rem] pl-8 px-3 bg-inherit py-2 placeholder:text-sm placeholder:mt-1 !border-gray-200 rounded-lg'
      />
    </div>
  );
};
